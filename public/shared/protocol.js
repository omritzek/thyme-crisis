...
var PROTOCOL = {
  ...
  MSG_COVER_STATUS: 'cover_status', // phone -> display, sent on entering/leaving cover: { inCover }
  ...
  MSG_PLAYER_HIT: 'player_hit',           // display -> one phone (targetPlayerId): lost a life (but not necessarily eliminated) -- flashes red
  ...
  PLAYER_COLORS: ['#ff4d4d', '#4da3ff', '#4dff88', '#ffd24d', '#c77dff'],
  MAX_PLAYERS: 5,
